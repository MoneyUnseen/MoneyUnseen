    ...
    <div className="glass rounded-2xl p-6 shadow-lg">
      ...
      {totalMonthlySpend > 0 ? (
        ...
        <div className="text-center py-8 text-gray-500">
          <p className="mb-2 font-medium text-gray-700">Add your first subscription to see the real picture</p>
          <p className="text-sm">Once you track what you pay, we'll show you what it could become instead.</p>
        </div>
      )}
    </div>
  )
