...
export default function FixedCostNudge({ subCount, onAddFixedCost, onDismiss }: FixedCostNudgeProps) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button onClick={onAddFixedCost} style={{ background: '#7c3aed', color: '#fff', border: 'none', borderRadius: 8, padding: '0.5rem 1rem', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'system-ui' }}>
              Add fixed costs
            </button>
            <button onClick={handleDismiss} style={{ background: 'transparent', color: '#7c6eaa', border: 'none', borderRadius: 8, padding: '0.5rem 0.75rem', fontSize: '0.8rem', fontWeight: 500, cursor: 'pointer', fontFamily: 'system-ui' }}>
