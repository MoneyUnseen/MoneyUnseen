...
function Divider() {
  return <div style={{ height: 1, background: s.grey100, margin: '0' }} />
}
...
export default function App() {
  ...
  const [waitlistCount, setWaitlistCount] = useState(174)
  ...
  useEffect(() => {
    // setWaitlistCount(fetchedCount) — wire to your backend
  }, [])
